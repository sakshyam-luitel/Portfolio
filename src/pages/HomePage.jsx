                ...
                <div className='flex flex-col-reverse lg:flex-row mx-2 md:mx-6 border-indigo-200 dark:border-indigo-900/40 border-4 p-4 lg:object-contain lg:pr-4 rounded-4xl justify-between min-w-0 bg-white dark:bg-slate-800 shadow-xl'>
                    <div className='flex flex-col gap-4 md:gap-6 lg:max-w-2xl border-4 border-indigo-100 dark:border-indigo-800/50 rounded-2xl p-4 md:p-8 shadow-md bg-indigo-50/30 dark:bg-slate-800/50'>
                        ...
                        <div className='flex justify-start gap-4 flex-wrap'>
                            <a href='./Resume.pdf' download><div className='flex bg-indigo-600 dark:bg-indigo-500 text-white hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors text-sm md:text-xl px-3 py-2 md:px-6 md:py-3 rounded-2xl items-center shadow-lg font-bold'>
                                <div className='p-0.5 hover:cursor-pointer mr-2'><Download/></div>
                                <button className='hover:cursor-pointer'>Download Resume </button>
                            </div></a>
                            <Link to = "/projects"><div className='flex border-4 border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors px-3 py-2 text-sm md:text-xl md:px-6 md:py-3 rounded-2xl items-center shadow-md font-bold'>
