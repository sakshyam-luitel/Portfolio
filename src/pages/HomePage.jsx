...
function HomePage(){
    return(
        <>
            <Navbar/>
            <div className='flex flex-col-reverse lg:flex-row mx-2 md:mx-4 border-cyan-500 border-1 p-4 lg:object-contain lg:pr-4 rounded-4xl justify-between'>
                <div className='flex flex-col gap:3 md:gap-4 lg:max-w-2xl border-1 border-violet-500 rounded-2xl  p-2 md:p-8'>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex bg-emerald-500 text-sm md:text-xl px-1 py-1 md:px-4 md:py-2 rounded-2xl items-center'>
                            <div className='p-0.5 hover:cursor-pointer'><Download/></div>
                            <button className='hover:cursor-pointer'>Download Resume </button>
                        </div>
                        <div className='flex border-1 border-sky-500 px-1 py-1 text-sm md:text-xl md:px-4 md:py-2 rounded-2xl items-center '>
